...
const QuizOption = ({ option, selectedOption, correctOption, isAnswerChecked, onSelect, }) => {
    ...
    return (<div className={optionClasses} onClick={onSelect} style={{ pointerEvents: isAnswerChecked ? "none" : "auto" }}>
